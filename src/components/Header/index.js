...
export default function (props) {
  ...
  return (
        <header>
            <div className='global-header' style={{backgroundColor: props.color}}>
                ...
                <div className='global-header-right'>
                    <button onClick={showModal} className='global-header-signin-btn'>
                        Sign in
                    </button>
                    <button className='global-header-signup-btn'>
                    <Link to={"/register"}>
                        Sign up
                        </Link>
                    </button>
