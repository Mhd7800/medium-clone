...
export const AuthModal = ({isOpen, handleCancel, handleOk}) =>{
   ...
   /* const signIn = async() =>{
       ...
       .then((result)=>{
        navigate("/");
        //console.log('user info is here'+result.data);
       })
    }*/
    ...
    >
        ...
        <h2>Join Medium</h2>
            ...
            <button >
            <Link to={"/register"}>
            <img width="25" height="25" src="https://img.icons8.com/ios/50/new-post--v1.png" alt="new-post--v1"/>
    ...
    <div className="modal-text">
        ...
        <span style={{color:"green", fontWeight:"bold"}}> <Link to={"/sigin"}>Sign in</Link></span>
        </p>
    </div>
    <div className='modal-footer'>
        <span>Click “Sign Up” to agree to Medium's Terms of Service and
        acknowledge that Medium's Privacy Policy applies to you.</span>
        </div>
    </div>
    </Modal>
  );
