        ...
        <div className='about'>
            <div className='about-items'>
                ...
                <div className='about-text'>
                    ...
                    <p style={{backgroundColor:"rgba(255, 255, 255, 0.6)"}}>Ultimately, our goal is to deepen our collective understanding of the world through the power of writing.</p>
